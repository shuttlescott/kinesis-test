...
func (c *Card) Node(ctx context.Context) (node *Node, err error) {
	...
	if buf, err = json.Marshal(c.Suit); err != nil {
		return nil, err
	}
	node.Fields[2] = &Field{
		Type:  "card.Suit",
...
func (pl *Player) Node(ctx context.Context) (node *Node, err error) {
	...
	var buf []byte
	if buf, err = json.Marshal(pl.CreateTime); err != nil {
		return nil, err
	}
	node.Fields[0] = &Field{
		Type:  "time.Time",
	...
	if buf, err = json.Marshal(pl.UpdateTime); err != nil {
		return nil, err
	}
	node.Fields[1] = &Field{
		Type:  "time.Time",
	...
	if buf, err = json.Marshal(pl.Age); err != nil {
		return nil, err
	}
	node.Fields[2] = &Field{
		Type:  "int",
	...
	if buf, err = json.Marshal(pl.Score); err != nil {
		return nil, err
	}
	node.Fields[4] = &Field{
		Type:  "int",
